...
const BeautyFilter = ({ applyFilters }) => {
  const [filters, setFilters] = useState({
    offers: false,
    deliveryFee: false,
    under30min: false,
    minRating: 0,
    beautyType: "", // Changed from householdType
      ...
      <div>
        <div className="filters">
          <label>
            Beauty Type:
            <select
              value={filters.beautyType}
              onChange={(e) => handleFilterChange("beautyType", e.target.value)}
              className="beautyFilter"
            >
